-- Migration v31:
-- Enrich the 'insufficient_funds' notification data with provider_profile_id,
-- provider_name, and quoted_amount so the customer's post page can render
-- a proper "tried to quote you" card with Message / Add Funds buttons.
